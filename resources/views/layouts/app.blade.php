...
<html lang="en">
	...
	<head>
        ...
        <link href="{{asset('assets/css/baselight.css')}}" rel="stylesheet" type="text/css" />
		<!-- <link href="./assets/css/demo1/skins/header/menu/light.css" rel="stylesheet" type="text/css" /> -->
        <link href="{{asset('assets/css/menulight.css')}}" rel="stylesheet" type="text/css" />
		<!-- <link href="./assets/css/demo1/skins/brand/dark.css" rel="stylesheet" type="text/css" /> -->
        <link href="{{asset('assets/css/branddark.css')}}" rel="stylesheet" type="text/css" />
		<!-- <link href="./assets/css/demo1/skins/aside/dark.css" rel="stylesheet" type="text/css" /> -->
        <link href="{{asset('assets/css/asidedark.css')}}" rel="stylesheet" type="text/css" />
...
@include('includes.header')
        ...
        <script src="{{asset('assets/js/js.cookie.js')}}" type="text/javascript"></script>
		<!-- <script src="./assets/vendors/general/moment/min/moment.min.js" type="text/javascript"></script> -->
        <script src="{{asset('assets/js/moment.min.js')}}" type="text/javascript"></script>
		<!-- <script src="./assets/vendors/general/tooltip.js/dist/umd/tooltip.min.js" type="text/javascript"></script> -->
        <script src="{{asset('assets/js/tooltip.min.js')}}" type="text/javascript"></script>
		<!-- <script src="./assets/vendors/general/perfect-scrollbar/dist/perfect-scrollbar.js" type="text/javascript"></script> -->
        <script src="{{asset('assets/js/perfect-scrollbar-js')}}" type="text/javascript"></script>
		<!-- <script src="./assets/vendors/general/sticky-js/dist/sticky.min.js" type="text/javascript"></script> -->
        <script src="{{asset('assets/js/sticky.min.js')}}" type="text/javascript"></script>
